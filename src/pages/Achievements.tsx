    ...
    <div className="py-16 bg-white min-h-screen">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <section className="mb-24">
          <div className="bg-blue-50 border-2 border-blue-200 rounded-3xl p-8 md:p-12 relative overflow-hidden shadow-xl">
            <div className="absolute top-0 right-0 p-12 opacity-5 pointer-events-none">
              <Star size={200} className="text-blue-600" />
            </div>
            <div className="relative z-10 flex flex-col md:flex-row items-center gap-10">
              <div className="w-40 h-40 bg-blue-200 rounded-full flex flex-col items-center justify-center text-school-green border-8 border-white shadow-lg shrink-0">
                <span className="text-4xl font-black">94.0%</span>
                <span className="text-sm font-bold uppercase tracking-tighter italic">Pass Rate</span>
              </div>
              <div>
                <div className="flex items-center gap-2 text-school-green font-bold uppercase tracking-widest text-sm mb-2">
                  <Star size={16} fill="currentColor" /> 2024 Matric Highlight <Star size={16} fill="currentColor" />
                </div>
                <h2 className="text-3xl md:text-5xl font-black text-school-green mb-4">Celebrating strong results</h2>
        ...
        <section className="mb-32">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">Celebrating outstanding learners.</p>
